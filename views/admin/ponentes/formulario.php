        ...
        <?php if(isset($ponente->imagen_actual)) {?>
            ...
            <div class="formulario__imagen">
                <picture>
                    ...
                    <img src="<?php echo $_ENV['HOST'] . '/build/img/speakers/' . $ponente->imagen . '.png'; ?>" alt="Imagen ponente">
                </picture>
            </div>
        <?php } ?>
    </div>
...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        <label for="tags_input">Áreas de Experiencia (separadas por comas)</label>
        <input 
            type="text"
            class="formulario__input"
            id="tags_input"
