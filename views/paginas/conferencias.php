<main class="agenda">
    ...
    <p class="agenda__descripcion">Talleres y conferencias impartidos por expertos en desarrollo web</p>
                    ...
                    <div class="evento__informacion">
                        ...
                        <div class="evento__autor-info">
                            <picture>
                                ...
                                <img class="evento__imagen-autor" loading="lazy" width="200" height="300" src="/build/img/speakers/<?php echo $evento->ponente->imagen; ?>.png" alt="Imagen ponente">
                            </picture>
